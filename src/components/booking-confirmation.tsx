...
export function BookingConfirmationMissing({ id }: { id: string }) {
  return (
    <div className="pt-24">
      <div className="mx-auto max-w-2xl px-4 py-16 md:px-6">
        <p className="text-xs tracking-[0.22em] text-[var(--brand-moss)] uppercase">
        ...
        <p className="mt-4 text-[var(--brand-ink)]/75">
          We couldn’t reload booking{" "}
          <span className="font-mono text-sm">{id}</span>. If you just booked,
          check your email or contact the lodge with your name and preferred
          date — your slot may still be held.
        </p>
        <div className="mt-8 flex flex-wrap gap-3">
          <ButtonLink
            href="/book"
